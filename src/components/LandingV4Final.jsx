...
const ACHIEVEMENTS = [
  {
    ...
    desc: 'Spain backed from the start. Won 1–0 AET.',
  ...
  },
  {
    ...
    desc: 'Three consecutive rounds above 90 — 99, 100, 91.',
    stat: '290 pts · GS rounds',
  },
  {
    tier: 'purple',
    icon: '🌍',
    title: 'Top 10,600 Worldwide',
    desc: '727 points across all 8 gameweeks.',
    stat: '#10,600 · WC Fantasy',
  },
];
